...
export const testerIps = async () => {
  ...
  // TODO: this fetch fails because there is a self signed certificate in the
  // certificate chain, and Cloudflare does not trust it.
  // https://community.cloudflare.com/t/worker-fetch-certificate-is-not-trusted/368684
